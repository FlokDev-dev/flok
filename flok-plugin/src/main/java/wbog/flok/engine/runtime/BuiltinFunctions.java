...
/**
 * Built-in functions callable from .fk scripts.
 * All functions are stateless — they read args and return a FValue.
 *
 * To add a new builtin: add a case to the switch below. No other file changes needed.
 */
final class BuiltinFunctions {
    ...
    static FValue call(String name, List<ASTNode> argExprs, ExecutionContext ctx, Interpreter interp) {
        // Evaluate all args eagerly (lazy eval only needed for and/or which are in BinaryOp)
