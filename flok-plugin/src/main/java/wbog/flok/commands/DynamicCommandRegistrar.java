...
/**
 * Injects script-defined commands into Bukkit's CommandMap at runtime.
 *
 * Paper 1.20+ exposes CommandMap directly via Bukkit.getServer().getCommandMap().
 * Reflection fallback included for compatibility.
 */
public final class DynamicCommandRegistrar {
    ...
    public void registerAll() {
        ...
        for (var entry : engine.getCommandIndex().entrySet()) {
            ...
            // Set description and aliases from the script's command block
    ...
    private static final class ScriptCommand extends Command {
        ...
        public boolean execute(CommandSender sender, String label, String[] args) {
            ...
            // Check permission defined in the script's command block (if any)
